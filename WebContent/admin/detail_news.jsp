                ...
                <div class="content-wrapper">
                    ...
                    <section class="content">
                        ...
                        <div class="box box-info">
                            ...
                            <!-- form start -->
                            <form action="${pageContext.request.contextPath}/approvenews.do"  method="post" enctype="" class="form-horizontal">
                            <input type="hidden" name="newsid" value="${news.newsId}" /> 
                                <div class="box-body">
		                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Title</label>
                                        <div class="col-sm-8">
                                             <textarea id="des" class="form-control" name="title" placeholder="Please enter title!" rows="5" cols="80" readonly>${news.newsName}</textarea>	                      	
                                        </div>		                      
		                    </div>  
		                      <div class="form-group">
                                        <label class="col-sm-2 control-label">Description</label>
                                        <div class="col-sm-8">
                                         <textarea  id="des" class="form-control" name="description" placeholder="Please enter description!" rows="5" cols="80" readonly>${news.description}</textarea>	                      	
                                        </div>		                      
		                    </div>  
		                    ...
		                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                             <img class="text-center" width="250" height="230" alt="Image" style="border:1px solid black;" src="${pageContext.request.contextPath}/images_news/${news.image}" >            
                                        </div>		                      
		                    </div>
		                    ...
		                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8"> 
                                            <textarea id="des" class="form-control" name="content" placeholder="Please enter content!" rows="15" cols="80" readonly>${news.content}</textarea>	                      	
		                 ...
		                 <div class="box-footer">
                                    <a href='${pageContext.request.contextPath}/listnews.do?action=back' class="btn btn-default">Back</a> 
                                    <c:if test="${news.approve == 0}"><input id="btnAdd" type="submit" class="btn btn-success pull-right" value='Approve'/> </c:if>
                                </div>
                            </form>                               
                        </div><!-- /.box -->
                    </section><!-- /.content -->
